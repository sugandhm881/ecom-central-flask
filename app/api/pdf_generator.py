...
class PDF(FPDF):
    ...
    def create_summary(self, adset_data, since, until):
        ...
        self.cell(47.5, 10, 'Total Spend:', 0, 0, 'C')
        self.cell(47.5, 10, 'Total Orders:', 0, 0, 'C')
        self.cell(47.5, 10, 'Overall CPO:', 0, 0, 'C')
        self.cell(47.5, 10, 'Overall ROAS:', 0, 1, 'C')
        
        self.set_font('Helvetica', 'B', 12)
        self.set_text_color(0, 0, 0)
        self.cell(47.5, 6, f'Rs {total_spend:,.2f}', 0, 0, 'C')
        self.cell(47.5, 6, f'{total_orders}', 0, 0, 'C')
        self.cell(47.5, 6, f'Rs {overall_cpo:,.2f}', 0, 0, 'C')
        self.cell(47.5, 6, f'{overall_roas:.2f}x', 0, 1, 'C')
        self.ln(10)
    ...
    def create_table(self, adset_data):
        ...
        # Reset text color to black for table body
        self.set_text_color(0, 0, 0)
